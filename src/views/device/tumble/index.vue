  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
        ...
        <el-table-column v-permission="['admin','dTumble:edit','dTumble:del']" label="操作" width="150px" align="center">
          <template slot-scope="scope">
            <udOperation
              :data="scope.row"
...
<script>
import crudDTumble from '@/api/dTumble'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '跌倒报警器', url: 'api/dTumble', sort: 'id,desc', crudMethod: { ...crudDTumble }})
...
export default {
  ...
  data() {
    return {
      ...
      permission: {
        add: ['admin', 'dTumble:add'],
        edit: ['admin', 'dTumble:edit'],
        del: ['admin', 'dTumble:del']
      },
      rules: {
        imei: [
